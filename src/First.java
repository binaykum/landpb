...
public class First   extends JFrame {
  ...
  {
    String sql1 = "select plotNo from z_plot_master where  z_plot_master.projAct= "+'"' +Login.projAct+  '"'+" and villageName= '" + this.cb1.getSelectedItem().toString() + "' order by cast(plotNo as unsigned);";
    try
    {
  ...
  {
    String sql1 = "select distinct(khataNo) from z_plot_master where  z_plot_master.projAct= "+'"' +Login.projAct+  '"'+" and villageName= '" + this.cb1.getSelectedItem().toString() + "' order by cast(khataNo as unsigned);";
  ...
  private void initComponents()
  {
    ...
    this.cb5.addActionListener(new ActionListener()
    {
      ...
      {
        First.this.cb5ActionPerformed(evt);
      }
    });
    ...
    this.rb2.addItemListener(new ItemListener()
    {
      ...
      {
        First.this.rb2ItemStateChanged(evt);
      }
    });
    this.rb2.addActionListener(new ActionListener()
    {
      public void actionPerformed(ActionEvent evt)
      {
        First.this.rb2ActionPerformed(evt);
      }
    });
  //  this.cb9.setModel(new DefaultComboBoxModel(new String[] { "No", "Yes" }));
      this.cb9.setModel(new DefaultComboBoxModel(new String[] { "Tenancy", "GM" }));
    ...
    this.rb1.addItemListener(new ItemListener()
    {
      public void itemStateChanged(ItemEvent evt)
      {
        First.this.rb1ItemStateChanged(evt);
      }
    });
    this.rb1.addActionListener(new ActionListener()
    {
      public void actionPerformed(ActionEvent evt)
      {
        First.this.rb1ActionPerformed(evt);
      }
    });
    ...
    this.cb2.addItemListener(new ItemListener()
    {
      public void itemStateChanged(ItemEvent evt)
      {
        First.this.cb2ItemStateChanged(evt);
      }
    });
    this.cb2.addActionListener(new ActionListener()
    {
      public void actionPerformed(ActionEvent evt)
      {
        First.this.cb2ActionPerformed(evt);
      }
    });
 ...
 //  this.cb4.setModel(new DefaultComboBoxModel(new String[] { "I", "II", "III", "IV", "V", "VI" }));
    this.cb4.addActionListener(new ActionListener()
    {
      public void actionPerformed(ActionEvent evt)
      {
        First.this.cb4ActionPerformed(evt);
      }
    });
    ...
    this.cb1.addItemListener(new ItemListener()
    {
      public void itemStateChanged(ItemEvent evt)
      {
        First.this.cb1ItemStateChanged(evt);
      }
    });
    this.cb1.addActionListener(new ActionListener()
    {
      public void actionPerformed(ActionEvent evt)
      {
        First.this.cb1ActionPerformed(evt);
      }
    });
    ...
    this.cb3.addActionListener(new ActionListener()
    {
      public void actionPerformed(ActionEvent evt)
      {
        First.this.cb3ActionPerformed(evt);
      }
    });
    ...
    this.btn3.addActionListener(new ActionListener()
    {
      public void actionPerformed(ActionEvent evt)
      {
        First.this.btn3ActionPerformed(evt);
      }
    });
                     ...
                     this.btn4.addActionListener(new ActionListener()
    {
      ...
      {
          try {
              First.this.btn4ActionPerformed(evt);
    ...
    this.cx7.addItemListener(new ItemListener()
    {
      public void itemStateChanged(ItemEvent evt)
      {
        First.this.cx7ItemStateChanged(evt);
      }
    });
    ...
    this.cx1.addItemListener(new ItemListener()
    {
      public void itemStateChanged(ItemEvent evt)
      {
        First.this.cx1ItemStateChanged(evt);
      }
    });
    ...
    this.tf2.addActionListener(new ActionListener()
    {
      public void actionPerformed(ActionEvent evt)
      {
        First.this.tf2ActionPerformed(evt);
      }
    });
    ...
    this.btn2.addActionListener(new ActionListener()
    {
      public void actionPerformed(ActionEvent evt)
      {
        First.this.btn2ActionPerformed(evt);
      }
    });
    this.cb7.setEditable(true);
    this.cb7.setBorder(BorderFactory.createTitledBorder(null, "Details verified ?", 0, 0, new Font("Tahoma", 0, 12)));
    this.cb7.addActionListener(new ActionListener()
    {
      public void actionPerformed(ActionEvent evt)
      {
        First.this.cb7ActionPerformed(evt);
      }
    });
    ...
    this.jLabel1.setText(Login.projAct+ "- Plot wise details ");
...
btn4.setVisible(true);
  ...
  private void fillEdits()
  {
    try
    {
      ...
      String sql = "select * from z_plot_master where villageName='" + Table_click1 + "' and plotNo='" + Table_click2 + "';";
      this.pst = this.conn.prepareStatement(sql);
      this.rs = this.pst.executeQuery();
      if (this.rs.next())
      {
        ...
        String add5 = this.rs.getString("verified");
  ...
  private void update()
  {
    ...
    if (p == 0) {
      try
      {
        ...
        String s4 = ", verified='" + this.cb7.getSelectedItem().toString() + "'";
        ...
        String sql = " update z_plot_master   set  " + s1 + s2 + s3 + s4 + "  , modifiedBy=current_user(), modifiedDate=curDate() Where villageName= '" + Table_click1 + "' and plotNo= '" + Table_click2 + "' ; ";
  ...
  private void searchResults()
  {
    ...
    try
    {
      ...
      if (this.cx5.isSelected()) {
          ...
          if (this.cb9.getSelectedItem().toString() == "Tenancy")
        {
          String s7 = " and Substring(landType,1,1)=\"T\"";
          s = s + s7;
        }
        else if (this.cb9.getSelectedItem().toString() == "GM")
        {
          String s7 = " and Substring(landType,1,1)=\"G\"" ;
          s = s + s7;
        }
        /*
      ...
      if (this.cx6.isSelected()) {
        ...
        {
          String s8 = " and workStartedOn is  null ";
          s = s + s8;
        }
        else if (this.cb10.getSelectedItem().toString() == "Yes")
        {
          String s8 = " and workStartedOn is not null  ";
          s = s + s8;
        }
      }
      ...
      sql = " select z_plot_master.villageName as Village,z_plot_master.plotNo,phaseName as Phase,khataNo,khatiyaniArea,acqdArea, round(sum(paidArea),2) as paidArea, round((acqdArea-coalesce(sum(paidArea),0)),2) as unpaidArea,landType,priorityTimewise as Priority,priorityUsagewise as Priority,housesNo,assets,workStartedOn  from landpb.z_plot_master  left outer join landpb.plot_vendor_wise_paidarea on z_plot_master.projAct=plot_vendor_wise_paidarea.projAct and z_plot_master.villageName=plot_vendor_wise_paidarea.villageName and z_plot_master.plotNo=plot_vendor_wise_paidarea.plotNo    " + s + "  group by  z_plot_master.villageName, z_plot_master.plotNo";
      ...
      String sql1 = " select count(distinct z_plot_master.villageName, z_plot_master.plotNo),sum( acqdArea), sum(paidArea1) from z_plot_master  left join (select projAct,villageName, plotNo, sum(paidArea) as paidArea1 from  plot_vendor_wise_paidarea group by villageName, plotNo) as T on z_plot_master.projAct=T.projAct and z_plot_master.villageName=T.villageName and z_plot_master.plotNo=T.plotNo  " + s;
